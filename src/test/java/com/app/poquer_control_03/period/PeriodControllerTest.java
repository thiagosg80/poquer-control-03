...
public class PeriodControllerTest {
    ...
    @Test
    void deveObterOsPeriodos() throws Exception {
        final String actual = MockGet.perform("/api/periods", mockMvc);
        final String expected = ExpectedJSON.get("expected-periods");
